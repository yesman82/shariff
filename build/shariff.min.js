...
/*!
 * shariff - v1.22.0 - 04.12.2015
 * https://github.com/yesman82/shariff
...
},{"jquery":6,"url":5}],11:[function(require,module,exports){
(function (global){
"use strict";var $=require("jquery"),url=require("url"),Shariff=function(t,e){var n=this;this.element=t,$(t).empty(),this.options=$.extend({},this.defaults,e,$(t).data());var r=[require("./services/facebook"),require("./services/googleplus"),require("./services/info"),require("./services/twitter")];this.services=$.map(this.options.services,function(t){var e;return r.forEach(function(r){return r=r(n),r.name===t?(e=r,null):void 0}),e}),this._addButtonList()};Shariff.prototype={defaults:{theme:"color",infoUrl:"http://ct.de/-2467514",lang:"de",langFallback:"en",mediaUrl:null,orientation:"horizontal",referrerTrack:null,services:["facebook","twitter","googleplus","info"],title:function(){return $("head title").text()},twitterVia:null,flattrUser:null,flattrCategory:null,url:function(){var t=global.document.location.href,e=$("link[rel=canonical]").attr("href")||this.getMeta("og:url")||"";return e.length>0&&(e.indexOf("http")<0&&(e=global.document.location.protocol+"//"+global.document.location.host+e),t=e),t}},$socialshareElement:function(){return $(this.element)},getLocalized:function(t,e){return"object"==typeof t[e]?"undefined"==typeof t[e][this.options.lang]?t[e][this.options.langFallback]:t[e][this.options.lang]:"string"==typeof t[e]?t[e]:void 0},getMeta:function(t){var e=$('meta[name="'+t+'"],[property="'+t+'"]').attr("content");return e||""},getInfoUrl:function(){return this.options.infoUrl},getURL:function(){return this.getOption("url")},getOption:function(t){var e=this.options[t];return"function"==typeof e?$.proxy(e,this)():e},getTitle:function(){return this.getOption("title")},getReferrerTrack:function(){return this.options.referrerTrack||""},_updateCounts:function(t){var e=this;$.each(t,function(t,n){n>=1e3&&(n=Math.round(n/1e3)+"k"),$(e.element).find("."+t+" a").append('<span class="share_count">'+n)})},_addButtonList:function(){var t=this,e=this.$socialshareElement(),n="theme-"+this.options.theme,r="orientation-"+this.options.orientation,i="col-"+this.options.services.length,a=$("<ul>").addClass(n).addClass(r).addClass(i);this.services.forEach(function(e){var n=$('<li class="shariff-button">').addClass(e.name),r='<span class="share_text">'+t.getLocalized(e,"shareText"),i=$("<a>").attr("href",e.shareUrl).append(r);"undefined"!=typeof e.faName&&i.prepend('<span class="fa '+e.faName+'">'),e.popup?i.attr("data-rel","popup"):e.blank&&i.attr("target","_blank"),i.attr("title",t.getLocalized(e,"title")),i.attr("role","button"),i.attr("aria-label",t.getLocalized(e,"title")),n.append(i),a.append(n)}),a.on("click",'[data-rel="popup"]',function(t){t.preventDefault();var e=$(this).attr("href"),n="_blank",r="600",i="460",a="width="+r+",height="+i;global.window.open(e,n,a)}),e.append(a)}},module.exports=Shariff,global.Shariff=Shariff,$(".shariff").each(function(){this.hasOwnProperty("shariff")||(this.shariff=new Shariff(this))});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./services/facebook":7,"./services/googleplus":8,"./services/info":9,"./services/twitter":10,"jquery":6,"url":5}]},{},[11]);
